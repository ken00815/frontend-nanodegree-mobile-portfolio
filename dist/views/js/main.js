...
var resizePizzas = function(size) {
    ...
    // Use Switch to redirect the size of the pizzas
    function changePizzaSizes(size) {
        var newWidth;
        //Directly assign the width since there are only 3 possible width
        switch (size) {
            case "1":
                newWidth = 25;
                break;
    ...
    // eliminate the determineDx() which is unnecessary
...
function updatePositions() {
    ...
    // run the for-loop 5 times instead of 200 times since there are patterned results
    var phase = [];
    for (var i = 0; i < 5; i++) {
